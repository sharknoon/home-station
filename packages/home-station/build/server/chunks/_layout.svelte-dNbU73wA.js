...
import { c as create_ssr_component, v as validate_component, g as each, e as escape, b as add_attribute, m as missing_component, s as setContext, h as getContext, d as spread, i as escape_attribute_value, f as escape_object, j as add_styles, a as createEventDispatcher } from './ssr-7I8bkXxs.js';
import { I as Icon$1 } from './Icon-Z8qjZ-ni.js';
import { siGithub } from 'simple-icons';
import './client-_MkdHwD5.js';
import { p as page } from './stores3-LPogNXES.js';
import { g as getToastStore } from './stores2-aoMI_yVo.js';
import { p as prefersReducedMotionStore, m as modeCurrent, s as setInitialClassState } from './ProgressBar.svelte_svelte_type_style_lang-sRcjXr2g.js';
import { s as slide } from './index3-IyzMm1tg.js';
...
const Layout_grid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon$1, "Icon").$$render($$result, Object.assign({}, { name: "layout-grid" }, $$props, { iconNode }), {}, {
    default: () => {
...
const Log_out = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon$1, "Icon").$$render($$result, Object.assign({}, { name: "log-out" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
...
const Circle_user_round = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon$1, "Icon").$$render($$result, Object.assign({}, { name: "circle-user-round" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
...
//# sourceMappingURL=_layout.svelte-dNbU73wA.js.map
