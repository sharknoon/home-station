...
type LayoutRouteId = RouteId | "/(sidebar)" | "/(sidebar)/account" | "/(sidebar)/discover" | "/(sidebar)/settings/container-engines" | "/(sidebar)/settings/domains-and-hostnames" | "/(sidebar)/settings/logs" | "/(sidebar)/settings/tasks" | "/(sidebar)/settings/users" | "/login" | "/setup" | null
