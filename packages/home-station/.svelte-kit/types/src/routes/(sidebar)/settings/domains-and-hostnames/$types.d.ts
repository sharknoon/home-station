...
type RouteParams = {  };
type RouteId = '/(sidebar)/settings/domains-and-hostnames';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(sidebar)/settings/domains-and-hostnames/+page.server.js').load>>>>>>;
