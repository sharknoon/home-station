...
type RouteParams = {  };
type RouteId = '/(sidebar)/settings/container-engines';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(sidebar)/settings/container-engines/+page.server.js').load>>>>>>;
