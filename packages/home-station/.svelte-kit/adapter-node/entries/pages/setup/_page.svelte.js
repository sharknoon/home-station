import { s as subscribe, c as compute_slots, b as set_store_value } from "../../../chunks/utils2.js";
import { c as create_ssr_component, s as setContext, e as escape, a as createEventDispatcher, g as getContext, b as add_attribute, h as each, o as onDestroy, v as validate_component } from "../../../chunks/ssr.js";
import { p as prefersReducedMotionStore } from "../../../chunks/ProgressBar.svelte_svelte_type_style_lang.js";
import { w as writable } from "../../../chunks/index2.js";
import { s as slide, a as fade } from "../../../chunks/index3.js";
      ...
      default: () => {
        return `${validate_component(Step, "Step").$$render(
          ...
          default: () => {
            ...
            })}</ul> <div><p>${escape($i18n.t("setup.add-domain-or-hostname"))}</p> <div class="input-group input-group-divider grid-cols-[1fr_auto]"><input type="text"${add_attribute("placeholder", $i18n.t("setup.domain-hostname-placeholder"), 0)}${add_attribute("value", hostnameInput, 0)}> <button type="button" class="variant-filled-secondary">${validate_component(Plus, "Plus").$$render($$result, {}, {}, {})}</button></div></div> <span class="badge variant-filled">${escape($i18n.t("setup.tip"))}</span> <span class="grow text-sm">${escape($i18n.t("setup.additional-domains-or-hostnames"))}</span>`;
          }
        })}`;
      }
    }
