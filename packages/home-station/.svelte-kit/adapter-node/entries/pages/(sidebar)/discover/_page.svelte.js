...
import { a as i18n, l as ls } from "../../../../chunks/i18n.js";
...
const Hard_drive_download = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon, "Icon").$$render($$result, Object.assign({}, { name: "hard-drive-download" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
...
const Library_big = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Icon, "Icon").$$render($$result, Object.assign({}, { name: "library-big" }, $$props, { iconNode }), {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
  })}`;
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}</ul>  <button disabled class="btn btn-sm variant-filled-primary space-x-2">${validate_component(Plus, "Plus").$$render($$result, {}, {}, {})} <span>${escape($i18n.t("discover.add-marketplace"))}</span></button>  ${!data.marketplaces.some((marketplace) => marketplace.gitRemoteUrl === "https://github.com/home-station-org/apps.git") ? `<button disabled class="btn btn-sm variant-filled-secondary space-x-2 ml-2">${validate_component(Plus, "Plus").$$render($$result, {}, {}, {})} <span>${escape($i18n.t("discover.add-default-marketplace"))}</span></button>` : ``}</div> <div class="arrow bg-surface-100-800-token"></div></div></div> <div class="grid grid-cols-4 gap-4">${each(data.marketplaceApps, (app) => {
