import * as server from '../entries/pages/(sidebar)/settings/tasks/_page.server.ts.js';

export const index = 9;
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/(sidebar)/settings/tasks/_page.svelte.js')).default;
export { server };
export const server_id = "src/routes/(sidebar)/settings/tasks/+page.server.ts";
